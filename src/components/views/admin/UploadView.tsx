...
import { Upload as UploadIcon, X, FileAudio, Image as ImageIcon, Check, Loader, CloudUpload, Info, Calendar, HardDrive, Link as LinkIcon, Music, ZoomIn, ZoomOut, Save, Plus } from 'lucide-react';
