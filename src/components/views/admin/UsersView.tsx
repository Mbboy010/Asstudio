                            ...
                            <tr key={user.id} className="group hover:bg-rose-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                                ...
                                <td className="px-6 py-4">
                                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize border ${
                                        ...
                                        : 'bg-gray-100 text-gray-800 border-gray-200 dark:bg-zinc-800 dark:text-gray-300 dark:border-zinc-700'
                                    }`}>
                                    {user.role}
                                    </span>
                                </td>
                                ...
                                <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold border ${
                                    ...
                                    : 'bg-green-100 text-green-700 border-green-200 dark:bg-green-900/20 dark:text-green-500 dark:border-green-900/30'
                                }`}>
